...
def arg_parser():
    ...
    parser.add_argument('--weight', nargs='+', type=str, default='weights/exp/', help='path to model weight')
    ...
    parser.add_argument('--data_path', nargs='+', type=str, default='dataset/test/', help='path to testing data')
    
    parser.add_argument('--rect', action='store_true', help='padding the image into rectangle')
    parser.add_argument('--visualize', action='store_true', help='visualise the ground truth and prediction on original image')
